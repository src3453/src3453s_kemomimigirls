...
colors = {'salt': (149, 149, 149, 255), 'caerbannog': (217, 217, 217, 255), 'toast': (48, 48, 48, 255), 'brown': (88, 48, 38, 255), 'gold': (255, 191, 137, 255), 'black': (37, 14, 14, 255), 'white': (217, 217, 217, 255), 'white_splotched': (173, 126, 185, 255)}
...
for head_name in heads:
    for costume_name in costumes:
        ...
        cv2.imwrite(os.path.join(OUTPUT_DIR,head_name.split(".")[0]+str(int(costume_name.split(".")[0]))+".png"),result)
        print(head_name.split(".")[0]+str(int(costume_name.split(".")[0]))+".png")